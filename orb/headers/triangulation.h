...
struct Tetrahedron
{
	...
	Boolean				has_correct_orientation; /* normal_surface_splitting.c (local)	*/
        ...
        Boolean                         is_flat; /* DJH */
	double				dihedral_angle[4][6]; /* DJH : penultimate/ultimate */
	double				dual_basis[4][4]; /* DJH */
	double				basis[4][4];	/* DJH */
	double				Gram_matrix[4][4]; /* DJH */
	double				inverse_Gram_matrix[4][4]; /* DJH */
        double                          eigenvalue[4]; /* DJH */
        double				orientation_parameter[4]; /* DJH */
...
struct Cusp
{
	...
	int					euler_characteristic;	/* cusps.c (local)						*/
        double					orbifold_euler_characteristic; /* DJH */
...
struct Triangulation
{
	...
	int					num_tetrahedra;			/* number of tetrahedra					*/
        ...
        double                          curvature[2]; /* DJH */
	double				approach_value; /* DJH */
...
extern Boolean realize_tetrahedron_from_angles( Tetrahedron *tet ); /* DJH */
extern Boolean realize_tetrahedron_from_lengths( Tetrahedron *tet ); /* DJH */
#endif
