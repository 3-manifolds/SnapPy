...
enum
{
	...
	geometric_solution,		/*	all positively oriented tetrahedra	*/
...
enum
{
    oriented_orbifold, /* DJH */
    oriented_manifold,
    nonorientable_orbifold, /* DJH */
...
typedef struct FundamentalEdge				FundamentalEdge; /* DJH */
typedef struct CurveSegment				CurveSegment;	/* DJH */
...
extern void			canonical_retriangulation(Triangulation *manifold, Boolean attaching_two_handle );
...
/*	cusp_fundamental_domains.c	DJH */
/**************************************************************************/

extern void cusp_fundamental_domain( Triangulation *manifold);
 ...
 */
extern double get_matrix_entry( GroupPresentation *fg, int i, int j, int k ); /* DJH */
extern int get_word_length( GroupPresentation *fg, int word ); /* DJH */
extern int get_letter( GroupPresentation *fg, int word, int letter ); /* DJH */
extern int fg_get_num_parabolic_relations( GroupPresentation       *group); /* DJH */
extern O31Matrix *get_matrices( GroupPresentation *fg ); /* DJH */
/*
...
extern int	*fg_get_relation(	GroupPresentation	*group,
								int					which_relation);
extern int	*fg_get_parabolic_relation( GroupPresentation *group, int which_relation );
/*
...
extern Triangulation	*read_italian_census( int n, double ***, char * );
...
extern void new_matrix_generators(  Triangulation                   *manifold,
                                                                O31Matrix   generators[]);
/*
...
/*	tetrahedron_realization.c  DJH */
/************************************************************************/

extern int mirrored_generalized_tetrahedron( O31Matrix *gen, GL4RMatrix basis, GL4RMatrix dual_basis ); /* DJH */
...
/***************************/
/* find_triangulation.c	   */
/***************************/

extern int find_triangulation( Triangulation *manifold, Triangulation ***list, int num_triangulation, int max_randomizations );
