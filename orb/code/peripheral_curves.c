...
static void				find_topology(PerimeterPiece *perimeter_anchor, CuspTopology *cusp_topology);
	...
	Cusp		*cusp )
{
	...
	find_topology(perimeter_anchor, &cusp->topology);
