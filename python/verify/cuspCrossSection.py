...
class ComplexCuspCrossSection(CuspCrossSectionBase):
    ...
    def add_vertex_positions_to_horotriangles(self):
        ...
        fixed point of these similarities can be assigned to each
        horotriangle as well by calling
        add_fixed_point_to_horotriangles after
    ...
    def add_fixed_point_to_horotriangles(self):
        """
        Assigns to each horotriangle a fixed point. This function
        needs to be called after add_vertex_positions_to_horotriangles.
        
        The fixed point is None for a complete cusp and a complex number
        for an incomplete cusp.
        """
        ...
        for cusp, cusp_info in zip(self.mcomplex.Vertices,
            ...
            if cusp_info['complete?']:
                # For a complete cusp, fixed point is None
                fixed_pt = None
            else:
            ...
            for corner in cusp.Corners:
                ...
                tet.horotriangles[vert].fixed_point = fixed_pt
