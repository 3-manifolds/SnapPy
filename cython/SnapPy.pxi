...
cdef extern from "SnapPea.h":
    ...
    extern c_GroupPresentation *fundamental_group(c_Triangulation *manifold, Boolean simplify_presentation, Boolean fillings_may_affect_generators, Boolean minimize_number_of_generators, Boolean minimize_lex_relator_length, Boolean try_hard_to_shorten_relators) except *
