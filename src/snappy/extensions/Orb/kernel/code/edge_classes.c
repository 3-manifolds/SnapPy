...
extern void	create_one_edge_class(
	Triangulation	*manifold,
	Tetrahedron		*tet,
	EdgeIndex		e)
{
	 ...
	 */
	new_edge_class->is_singular			= FALSE; /* DJH */
        new_edge_class->singular_order                  = 1; /* DJH */
	new_edge_class->old_singular_order			= 1; /* DJH */
        new_edge_class->singular_index                  = -1; /* DJH */
