...
/****************************************/
/*
extern Triangulation *attach_2_handle( Triangulation *manifold, CurveSegment *curve );
*/
...
void remove_bad_vertices(Triangulation *manifold );
/*
...
extern Boolean		contain_flat_tetrahedra( Triangulation *manifold ); 
extern void compute_cusp_euler_characteristics( Triangulation *manifold );
extern void		identify_cusps( Triangulation *manifold );
/*
...
extern FuncResult	three_to_two(EdgeClass *edge, EdgeClass **where_to_resume, int *num_tetrahedra_ptr, Boolean keep_shapes);
extern FuncResult	two_to_three(Tetrahedron *tet0, FaceIndex f, int *num_tetrahedra_ptr, Boolean keep_shapes);
...
extern Triangulation *subdivide(Triangulation *manifold, char *new_name, Boolean remove_extras ); /* DJH */
/*
