...
if sys.platform == 'darwin':
    ...
    if platform.architecture()[0] == '32bit':
        CyOpenGL_extras += ['opengl/glew/lib/win/Win32/glew32s.lib']
    else:
        CyOpenGL_extras += ['opengl/glew/lib/win/x64/glew32s.lib']
    if cc == 'msvc':
...
setup( name = 'snappy',
       ...
       packages = ['snappy', 'snappy/manifolds', 'snappy/twister',
                   ...
                   'snappy/dev',
                   'snappy/dev/raytracing',
                   'snappy/dev/raytracing/upper_halfspace',
                   'snappy/dev/raytracing/shaders',
                   'snappy/togl',
       ],
       package_data = {
           ...
           'snappy/dev/raytracing/shaders' : ['*.glsl']
       },
       package_dir = {'snappy':'python', 'snappy/manifolds':'python/manifolds',
                      ...
                      'snappy/dev/raytracing': 'dev/raytracing',
                      'snappy/dev/raytracing/upper_halfspace': 'dev/raytracing/upper_halfspace',
                      'snappy/dev/raytracing/shaders': 'dev/raytracing/shaders'
                  }, 
